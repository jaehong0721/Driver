...
public class AwsS3FileUploader {
    ...
    public void upload(File file, String phoneNumber, TransferListener transferLisener) {
        TransferObserver transferObserver = transferUtility.upload(bucketName, "image/"+phoneNumber +"/"+file.getName(), file);
